...
Cast::Camera PhongScene::_cam{};

bool PhongScene::init() {
    ...
    CAST_LOG("{}", "Returning from PhongScene::init");
    CHECK_GL_ERROR();
...
void PhongScene::update(float delta){

    processInput(Cast::window);

}

void PhongScene::render(float delta) {
...
bool PhongScene::cleanup() {

    return true;
}


void PhongScene::processInput(GLFWwindow *window){
...
void PhongScene::mouse_callback(GLFWwindow* window, double xposIn, double yposIn){
...
void PhongScene::scroll_callback(GLFWwindow* window, double xoffset, double yoffset){
